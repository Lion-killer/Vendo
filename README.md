...
- **Розв'язання колізій.** Оптимістична конкуренція за токеном версії запису (409 + `serverState`), діалог «перезаписати / взяти серверне», заборона редагувати/видаляти проведене, версія-гард на видалення/відновлення. Деталі — [issue #33](https://github.com/Lion-killer/Vendo/issues/33).
