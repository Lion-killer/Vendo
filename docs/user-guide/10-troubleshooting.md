...
Меню профілю → **Журнал помилок** → **«Надіслати лог розробнику»**. Там же видно останні події додатку — зокрема невдалі спроби відправити замовлення з причиною відмови.

![Журнал помилок](images/log-panel.png)

> **Зазвичай надсилати вручну не потрібно:** якщо в додатку сталася помилка, він сам
> передасть журнал в офіс із черговим фоновим звітом (коли є інтернет). Офіс також може
> запросити повний журнал дистанційно — він поїде автоматично за наступного зв'язку.
> Звичайні перебої зв'язку (офлайн у дорозі) помилками не вважаються.
...
- **Товару немає в каталозі** — найчастіше в обліковій системі в нього не заповнена група або одиниця зберігання: такі позиції в застосунок не передаються. Повідом адміністратора.
...
- **Жовтий банер «Бекенд застарілий»** — версія 1С в офісі старіша за додаток; частина функцій може бути недоступна. Повідом адміністратора, щоб оновив 1С (дані й робота не блокуються).
- **Жовтий банер «Оновіть додаток»** — навпаки, додаток застарів для сервера. Онови його: меню профілю → кнопка оновлення.
