...
- **Сканер штрихкодів:** натисни значок сканера й піднеси камеру до штрихкоду товару. `[скріншот: сканер штрихкодів — зняти на пристрої]`

![Пошук у каталозі](images/catalog-search.png)

## Картка товару
У рядку товару видно ціну та залишок. Натисни на фото, щоб відкрити його на весь екран (там же — назва, артикул, штрихкод, ціна, залишок).
