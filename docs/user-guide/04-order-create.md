...
- **«Скопіювати в нове»** — швидко повторити замовлення тим самим клієнтом (товари й клієнт залишаються). Копія **одразу стає окремою чернеткою** з власним номером `ЧН-…` і сьогоднішньою датою: навіть якщо вийти з екрана кнопкою «назад», вона чекатиме в «Мої замовлення».
