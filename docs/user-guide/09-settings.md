...
Після виходу каталог, клієнти й замовлення з екранів зникають — вони підвантажаться заново при наступному вході. **Чернетки та черга на відправку зберігаються**, якщо зайти на тому самому пристрої. А якщо зісканувати QR **іншого** пристрою, всі дані попередньої прив'язки стираються — чужі замовлення й клієнти не потраплять на екран.
