// Чисті хелпери замовлень (без залежності від БД) — щоб їх можна було юніт-тестувати.
// Гідратація/нормалізація лишаються в routes/api.js, бо потребують доступу до SQLite.
