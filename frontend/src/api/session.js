...
export const getSession = () => {
    try {
        ...
        logError("Не вдалося прочитати сесію", String(e && e.message || e)); // #81
        return null;
    }
};
...
export const saveSession = (session) => {
    try {
        ...
        logError("Не вдалося зберегти сесію", String(e && e.message || e)); // #81: може пояснювати несподіваний вихід на екран входу
    }
};
